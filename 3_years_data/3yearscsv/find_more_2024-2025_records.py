#!/usr/bin/env python3
"""
Robust Deep WMS Discovery Script for 2024-25 Soil Health Data in SPSR Nellore.
...
LAYER_2024_25 = "28_515_shc_2024-25"
OUTPUT_FILE = "nellore_soil_data_2024-25.csv"
...
def main():
    ...
    print(f"Starting robust WMS parallel scan for 2024-25 layer across {len(bbox_list)} targets...")
        ...
        for i in range(0, len(bbox_list), chunk_size):
            ...
            try:
                ...
                if chunk_idx % 20 == 0 or chunk_idx == total_chunks:
                    print(f"[{chunk_idx}/{total_chunks}] Total 2024-25 Features: {len(discovered_features)} (+{new_found} new in this batch)")
    ...
    print(f"\n[SUCCESS] Completed discovery! Total 2024-25 soil records: {len(final_df)}")
