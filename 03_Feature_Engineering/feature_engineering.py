...
class SoilFeatureEngineer:
    ...
    def load_data(self) -> pd.DataFrame:
        ...
        if self.data_path and os.path.exists(self.data_path):
            ...
            # Look for standard project files in current and parent directories
            proj_root = Path(__file__).resolve().parent.parent
            candidates = [
                str(proj_root / '02_Satellite_Covariates' / 'ExtractDependencies' / 'SPSR_Nellore_Final_Comprehensive_SCORPAN_Dataset.csv'),
                str(proj_root / '02_Satellite_Covariates' / 'ExtractDependencies' / 'SPSR_Nellore_972_Points_Sentinel2_Bands.csv'),
                str(proj_root / '01_OCR_Raw_Data' / 'Soil_Test_Results.xlsx'),
